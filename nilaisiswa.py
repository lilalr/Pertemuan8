...
# Fungsi untuk menyimpan data baru ke dalam database
...
selected_id = StringVar() # Untuk menyimpan ID record yang dipilih

# Element GUI
Label(root, text="Nama Siswa", bg="#EFEFE9").grid(row=0, column=0, padx=10, pady=5)
Entry(root, textvariable=nama_var, bg="#EFEFE9").grid(row=0, column=1, padx=10, pady=5)

Label(root, text="Biologi", bg="#EFEFE9").grid(row=1, column=0, padx=10, pady=5)
Entry(root, textvariable=biologi_var, bg="#EFEFE9").grid(row=1, column=1, padx=10, pady=5)

Label(root, text="Fisika", bg="#EFEFE9").grid(row=2, column=0, padx=10, pady=5)
Entry(root, textvariable=fisika_var, bg="#EFEFE9").grid(row=2, column=1, padx=10, pady=5)

Label(root, text="Bahasa Inggris", bg="#EFEFE9").grid(row=3, column=0, padx=10, pady=5)
Entry(root, textvariable=inggris_var, bg="#EFEFE9").grid(row=3, column=1, padx=10, pady=5)

# Membuat tombol Add, Update, dan Delete
Button(root, text="Add", bg="#959D90", command=submit).grid(row=4, column=0, padx=10, pady=5)
Button(root, text="Update", bg="#959D90", command=update).grid(row=4, column=1, padx=10, pady=5)
Button(root, text="Delete", bg="#959D90", command=delete).grid(row=4, column=2, padx=10, pady=5)
